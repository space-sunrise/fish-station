...
using Content.Shared._Mono.GridEdgeMarker; // Fish
using Content.Shared.Maps; // Fish
using Content.Shared.Shuttles.Components;
using Robust.Client.AutoGenerated;
using Robust.Client.Graphics;
using Robust.Client.ResourceManagement;
using Robust.Client.UserInterface.XAML;
using Robust.Shared.Map; // Fish
...
public partial class BaseShuttleControl : MapGridControl
{
    ...
    [Dependency] private ITileDefinitionManager _tileDef = default!; // Fish
    protected readonly EntityLookupSystem _lookup; // Fish
    ...
    // Per-draw caching
    private readonly Dictionary<Vector2i, ContentTileDefinition> _gridTileList = new(); // Fish
    ...
    private EntityQuery<TransformComponent> _xformQuery; // Fish
    ...
    public BaseShuttleControl(float minRange, float maxRange, float range) : base(minRange, maxRange, range)
    {
        ...
        _lookup = EntManager.System<EntityLookupSystem>(); // Fish
        _xformQuery = EntManager.GetEntityQuery<TransformComponent>(); // Fish
    ...
    protected void DrawCircles(DrawingHandleScreen handle)
    {
        ...
        var origin = MidPointVector; // Fish
