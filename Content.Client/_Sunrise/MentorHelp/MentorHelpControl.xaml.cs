...
using Robust.Shared.GameObjects; //Fish-edit
...
using Robust.Client.Console; //Fish-edit
...
namespace Content.Client._Sunrise.MentorHelp
{
    ...
    public sealed partial class MentorHelpControl : Control
    {
        ...
        private void FollowPlayer()
        {
            ...
            // Look up the AdminSystem at runtime and get the player's NetEntity (if available)
            var adminSystem = EntitySystem.Get<Content.Client.Administration.Systems.AdminSystem>();
            var playerInfo = adminSystem?.PlayerList.FirstOrDefault(p => p.SessionId == _selectedTicket.PlayerId);

            if (playerInfo?.NetEntity != null)
            {
