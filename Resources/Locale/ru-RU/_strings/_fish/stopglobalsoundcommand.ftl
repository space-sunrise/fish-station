...
stop-global-admin-sound-player-not-found = Игрок { $username } не найден.
stop-global-admin-sound-usage = Неверный формат. Используйте: stopglobaladminsound [имя_игрока]
stop-global-admin-sound-arg-player = <имя_игрока>