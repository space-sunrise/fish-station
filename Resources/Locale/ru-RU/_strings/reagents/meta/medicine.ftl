...
reagent-name-vitera = Витэра
reagent-desc-vitera = Специализированное лекарство, которое напрямую лечит истощение. Эффективно для борьбы с истощением и метаболическим истощением.

reagent-name-genesis-ultra = Генезис-Ультра
reagent-desc-genesis-ultra = Продвинутое средство для лечения истощения, обеспечивающее быстрое заживление, но вызывающее генетические повреждения в качестве побочного эффекта. Используйте с осторожностью.