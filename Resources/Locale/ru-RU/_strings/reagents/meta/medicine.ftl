...
reagent-name-alpha = альфа
reagent-desc-alpha = Специализированное лекарство, которое напрямую лечит истощение.

reagent-name-beta = бета
reagent-desc-beta = Продвинутое средство для лечения истощения, обеспечивающее быстрое заживление, но вызывающее генетические повреждения в качестве побочного эффекта. Используйте с осторожностью.