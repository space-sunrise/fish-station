...
ent-OreProcessor = переработчик руды
    # FIsh edit start - описание автопоглощения и очков шахтёра
    .desc = Автоматически поглощает ближайшую руду, переплавляет её в листы и слитки и начисляет очки шахтёра.
    # FIsh edit end
ent-OreProcessorIndustrial = промышленный переработчик руды
    # FIsh edit start - описание автопоглощения и очков шахтёра
    .desc = Промышленная печь с автопоглощением руды и начислением очков шахтёра.
    # FIsh edit end
