...
health-analyzer-window-treatment-title = Treatment assistant
health-analyzer-window-treatment-none = No medication is currently required.
health-analyzer-window-treatment-unsupported = No chemical treatment recommendations are available for this patient.
