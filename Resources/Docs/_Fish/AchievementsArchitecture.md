...
Для сотен записей окно использует фильтрацию до создания элементов и ограниченное переиспользование строк. Сеть не отправляет отдельное сообщение на каждый элемент каталога.
